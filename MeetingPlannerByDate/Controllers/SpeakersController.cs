...
namespace MeetingPlanner.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public SpeakersController(ChurchContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SpeakerID,FirstName,LastName,Topic,MeetingID")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpeakerID,FirstName,LastName,Topic,MeetingID")] Speaker speaker)
        {
